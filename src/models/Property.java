...
public class Property {
    ...
    public static Property selectProperty(ResultSet rs) {
        try (Connection con = getConnection()) {
            int propertyID = rs.getInt("p.PropertyID");
            ...
            return new Property(propertyID, propertyName, propertyDescription, pricePerNight,
